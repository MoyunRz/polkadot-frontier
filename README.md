...
./frontier-template-node --chain=customSpec.json --base-path=/tmp/eve --execution=Native --db-cache=10 --in-peers=5000 --node-key=0x3e2e453139481ead85db296dcc610ecac7728b50ec1a00d9e8ef56882621b72a --port=30333 --ws-port=9944 --rpc-port=9933 --rpc-cors=all --unsafe-ws-external --unsafe-rpc-external --sync=Full