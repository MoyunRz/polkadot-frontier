	...
	ChainSpec::from_genesis(
		...
		move || {
			testnet_genesis(
				...
				// Pre-funded accounts
				vec![
					AccountId::from(hex!("7835d6ec37265e0bc3a57d499673fde1951d47a4")), // Alith
					AccountId::from(hex!("a2baba3d6dfdc58b4db8b8e71fc6ebb86cc1cb46")), // Baltathar
					AccountId::from(hex!("a433963e078609811c228e3a8aa85e60b87f532d")), // Charleth
				],
				vec![
			...
			accounts: {
				...
				map.insert(
					...
					fp_evm::GenesisAccount {
						balance: U256::from_str("0x11ffffffffffffffffffffffffffffff")
				...
				map.insert(
					...
					H160::from_str("a2baba3d6dfdc58b4db8b8e71fc6ebb86cc1cb46")
						.expect("internal H160 is valid; qed"),
					fp_evm::GenesisAccount {
				...
				map.insert(
					// H160 address of CI test runner account
					H160::from_str("a433963e078609811c228e3a8aa85e60b87f532d")
						.expect("internal H160 is valid; qed"),
					fp_evm::GenesisAccount {
						balance: U256::from_str("0xffffffffffffffffffffffffffffffff")
							.expect("internal U256 is valid; qed"),
				...
				map.insert(
					...
					H160::from_str("c437F98Ae6cB062f13F261d3Ed215C5437be9130")
						.expect("internal H160 is valid; qed"),
					fp_evm::GenesisAccount {
						nonce: U256::from(1),
